...
public class UnaryOperatorExample {
	...
	public static void main(String[] args) {
		...
		UnaryOperator<Integer> unaryMultiplyOperator = a -> {
			System.out.println("Multiply by 5 Unary operator");
			return a*5;
		};
		...
		System.out.println("Unary Multiply Operator Operation:" + unaryMultiplyOperator.apply(5));
