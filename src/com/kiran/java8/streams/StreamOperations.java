 ...
 * 
 */
package com.kiran.java8.streams;
...
public class StreamOperations {
	...
	public static void flatMapInStreams() {
		...
		/*Stream<String> streamTest = Arrays.stream(arrayOfWords);
		streamTest.map(word -> word.split(" "))
...
*/
	...
	public static void limitInStreams() {
		...
		Stream.generate(new Random():: nextDouble).limit(15).forEach(System.out::println);
	}

	public static void skipInStreams() {
		Stream.iterate(1, n -> n + 1).skip(10).limit(20).forEach(System.out::println);
		Stream.iterate(1, n -> n+1).skip(15).limit(30).forEach(System.out::println);

		Stream.iterate(40, n -> n-1).skip(15).limit(20).sorted().forEach(System.out::println);
	}
	...
	public static void collectingAndThenStreams() {
		...
		//List<Product> resultList = productList.stream().collect(Collectors.)

		String minPriceProduct = productList.stream().collect(Collectors.collectingAndThen(
		...
		System.out.println("The product with min price tag is: " + minPriceProduct);
	}
